 ...
 * - ~/.omr/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.omr/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.omr/agent/extensions/ or .omp/extensions/
