...
Managed skills: `SKILL.md` in isolated `~/.omr/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.omr/agent/skills` or `.omp/skills`.
