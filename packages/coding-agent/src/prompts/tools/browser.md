...
- `app.cmux: true` explicitly selects `CMUX_SOCKET_PATH`; `app.surface` borrows that exact stable cmux surface/browser resource. Omit `app.surface` to create a tool-owned cmux resource.
