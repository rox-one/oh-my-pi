 ...
 * isolated directory (`~/.omr/agent/managed-skills`) separate from
 * user-authored skills (`~/.omr/agent/skills`). They are discovered and
...
/** Resolve the isolated managed-skills directory (`~/.omr/agent/managed-skills`). */
