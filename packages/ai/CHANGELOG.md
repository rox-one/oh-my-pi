...
- Made Kimi device-id persistence best-effort: a missing or unwritable `~/.omr/agent` directory no longer throws during Kimi header construction, which silently nulled every `kimi-code` usage probe on fresh installs.
