...
- default agent dir: `~/.omr/agent`
- effective default file: `~/.omr/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.omr/agent/themes/my-theme.json`.
