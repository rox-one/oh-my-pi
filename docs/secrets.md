...
| Level   | Path                       | Purpose                     |
| ------- | -------------------------- | --------------------------- |
| Global  | `~/.omr/agent/secrets.yml` | Secrets across all projects |
| Project | `<cwd>/.omr/secrets.yml`   | Project-specific secrets    |
