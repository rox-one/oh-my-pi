...
Search roots come from `.omr` directories:

- project: `<cwd>/.omr/commands/*.md`
- user: active profile agent directory `commands/*.md` (`~/.omr/agent/commands/*.md` for the default profile; `~/.omr/profiles/<name>/agent/commands/*.md` for a named profile)
